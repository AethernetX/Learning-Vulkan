...
namespace pb{
    ...
    SimpleRenderSystem::SimpleRenderSystem(PbDevice& device, VkRenderPass renderPass, VkDescriptorSetLayout globalSetLayout) : pbDevice{device}{
    ...
    void SimpleRenderSystem::renderGameObjects(FrameInfo &frameInfo, std::vector<PbGameObject>& gameObjects){
