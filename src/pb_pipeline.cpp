...
namespace pb
{
    ...
    PbPipeline::~PbPipeline(){
        vkDestroyShaderModule(pbDevice.device(), vertShaderModule, nullptr);
        vkDestroyShaderModule(pbDevice.device(),fragShaderModule, nullptr);
        vkDestroyPipeline(pbDevice.device(), graphicsPipeline, nullptr);
    }
    ...
    void PbPipeline::createGraphicsPipeline(
        ...
        if(vkCreateGraphicsPipelines(pbDevice.device(), VK_NULL_HANDLE, 1, &pipelineInfo, nullptr, &graphicsPipeline) != VK_SUCCESS){
    ...
    void PbPipeline::defaultPipelineConfigInfo(PipelineConfigInfo& configInfo){
        ...
        configInfo.bindingDescriptions = PbModel::Vertex::getBindingDescriptions();
        configInfo.attributeDescriptions = PbModel::Vertex::getAttributeDescriptions();
    }
